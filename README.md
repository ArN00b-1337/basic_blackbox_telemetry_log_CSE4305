# basic_blackbox_telemetry_log_CSE4305
A C program that simulates a Flight Data Recorder using a Doubly Linked List, supporting both chronological and reverse crash analysis traversal.
#  Flight Data Recorder — Black Box Simulator
...
## Enter flight records when prompted:**
```
Enter number of flight records: 4

Record 1
Enter Altitude: 35000
Enter Airspeed: 450
Enter Pitch Angle: 2
Enter Timestamp: 10
```
